...
class TestSmokeTest():
  ...
  def test_admin(self):
    ...
    self.driver.find_element(By.ID, "username").send_keys("JayWalker")
    self.driver.find_element(By.ID, "password").click()
    self.driver.find_element(By.ID, "password").send_keys("asdfjkl;")
  ...
  def test_join(self):
    ...
    self.driver.find_element(By.NAME, "lname").send_keys("Walker")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("Petersen Inc.")
    self.driver.find_element(By.NAME, "biztitle").click()
    self.driver.find_element(By.NAME, "biztitle").send_keys("Project Engineer")
